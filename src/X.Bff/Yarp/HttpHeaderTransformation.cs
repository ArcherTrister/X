    ...
    internal class HttpHeaderTransformation : ITransformProvider
    {
        ...
        public void Apply(TransformBuilderContext transformBuilderContext)
        {
            ...
            transformBuilderContext.AddRequestTransform(async transformContext =>
            {
                ...
                logger.LogDebug("GetAccessToken: {accessToken}", userToken.Token?.AccessToken);
                transformContext.ProxyRequest.Headers.Authorization = new AuthenticationHeaderValue(OidcConstants.AuthenticationSchemes.AuthorizationHeaderBearer, userToken.Token?.AccessToken);
            });
        }
    }
#else
